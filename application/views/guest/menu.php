	        <div class="navbar-collapse collapse">
	          <ul class="nav navbar-nav navbar-right">
	            <li><a href="<?=base_url()?>" class="smothscroll navbar-btn"><i class="fa fa-home fa-fw"></i>หน้าหลัก</a></li>
							<li><a href="<?=base_url('guest/gis')?>" class="smothscroll navbar-btn"><i class="fa fa-map-marker fa-fw"></i>ข้อมูลเชิงภูมิศาสตร์</a></li>
	           <!--
